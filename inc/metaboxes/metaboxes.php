...
require_once 'metaboxes_options.php';
		...
		foreach ( $this->_meta_box['fields'] as $field ) {
			...
			switch ( $field['type'] ) {
				...
				case 'text':
					...
					break;
				case 'text_info':
					echo '<input type="text" readonly name="', esc_attr($field['id']), '" id="', esc_attr($field['id']), '" value="', '' !== $meta ? $meta : esc_attr($field['std']), '" />','<p class="ale_metabox_description">', esc_attr($field['desc']), '</p>';
					break;
				case 'text_small':
